...
export const scenarioPresets = {
    impactor: {
        ...
        description:
            "Données inspirées des estimations initiales d'Impactor-2025 lors de sa découverte en janvier 2025.",
        params: {
            mass: 28,
            radius: 0.9,
            velocity: 22,
            ...
            gravity: 9.81,
            density: 3.1,
        } satisfies SimulationParams,
    },
    oceanique: {
        label: 'Impact océanique',
        description:
            'Scénario privilégiant une entrée oblique au-dessus du Pacifique nord avec un impact majoritairement en mer.',
        params: {
            mass: 18,
            radius: 0.7,
            velocity: 19,
    ...
    continental: {
        ...
        description:
            "Simulation d'un impact proche des côtes avec une pénétration plus verticale et une masse légèrement supérieure.",
        params: {
            mass: 35,
            radius: 1.1,
            velocity: 24,
